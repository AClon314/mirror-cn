...
FMT = (
    ...
    if IS_JSON
    else "%(levelname)s %(asctime)s %(filename)s:%(lineno)d\t%(message)s"
)
...
def version():
    return (
        datetime.fromtimestamp(os.path.getmtime(__file__), tz=timezone.utc)
    ).strftime("%Y.%m.%d.%H.%M")
...
_GITHUB_AKAMS_CN = [
    [g + "/https://github.com", "", "https://github.akams.cn/"]
    for g in _GITHUB_AKAMS_CN
]
GITHUB_RELEASE = [
    ...
    [
        ...
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [WJQSERVER-STUDIO/ghproxy] 提供",
    ],
    [
    ...
    [
        "https://down.sciproxy.com/github.com",
        "美国",
    ...
    [
        ...
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [moeyy.cn] 提供",
    ],
    [
    ...
    [
        "https://ghdd.862510.xyz/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [ghdd.862510.xyz] 提供",
    ],
    [
    ...
    [
        "https://gh-proxy.linioi.com/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [gh-proxy.linioi.com] 提供",
    ],
    [
        "https://firewall.lxstd.org/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [firewall.lxstd.org] 提供",
    ],
    [
        "https://mirrors.chenby.cn/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [mirrors.chenby.cn] 提供",
    ],
    [
    ...
    [
        ...
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [ghfile.geekertao.top] 提供",
    ],
    [
        "https://ghp.keleyaa.com/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [ghp.keleyaa.com] 提供",
    ],
    [
        "https://github.wuzhij.com/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [github.wuzhij.com] 提供",
    ],
    ...
    [
        ...
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [gh.chjina.com] 提供",
    ],
    [
        "https://ghpxy.hwinzniej.top/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [ghpxy.hwinzniej.top] 提供",
    ],
    [
        "https://cdn.crashmc.com/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [cdn.crashmc.com] 提供",
    ],
    [
        "https://git.yylx.win/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [git.yylx.win] 提供",
    ],
    [
        "https://gitproxy.mrhjx.cn/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [gitproxy.mrhjx.cn] 提供",
    ],
    [
        "https://ghproxy.cxkpro.top/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [ghproxy.cxkpro.top] 提供",
    ],
    [
        "https://gh.xxooo.cf/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [gh.xxooo.cf] 提供",
    ],
    [
        "https://ghproxy.xiaopa.cc/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [ghproxy.xiaopa.cc] 提供",
    ],
    [
        "https://gh.944446.xyz/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [gh.944446.xyz] 提供",
    ],
    [
        "https://github.limoruirui.com/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [github.limoruirui.com] 提供",
    ],
    [
        "https://api-gh.muran.eu.org/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [api-gh.muran.eu.org] 提供",
    ],
    [
        "https://gh.idayer.com/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [gh.idayer.com] 提供",
    ],
    [
        "https://gh.zwnes.xyz/https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [gh.zwnes.xyz] 提供",
    ],
    # ['https://gh.llkk.cc/https://github.com', '美国', '[美国 Cloudflare CDN] - 该公益加速源由 [gh.llkk.cc] 提供'],
    [
        "https://down.npee.cn/?https://github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [npee社区] 提供",
    ],
    [
        "https://raw.ihtw.moe/github.com",
        "美国",
        "[美国 Cloudflare CDN] - 该公益加速源由 [raw.ihtw.moe] 提供",
    ],
    [
        "https://dgithub.xyz",
        "美国",
        "[美国 西雅图] - 该公益加速源由 [dgithub.xyz] 提供",
    ],
    [
    ...
    [
        "https://gh-proxy.ygxz.in/https://github.com",
        "美国",
        "[美国 洛杉矶] - 该公益加速源由 [gh-proxy.ygxz.in] 提供",
    ],
    [
        "https://gh.zwy.one/https://github.com",
        "美国",
        "[美国 洛杉矶] - 该公益加速源由 [gh.zwy.one] 提供",
    ],
    [
        "https://ghproxy.monkeyray.net/https://github.com",
        "美国",
        "[美国 洛杉矶] - 该公益加速源由 [ghproxy.monkeyray.net] 提供",
    ],
    [
        "https://gh.xx9527.cn/https://github.com",
        "美国",
        "[美国 洛杉矶] - 该公益加速源由 [gh.xx9527.cn] 提供",
    ],
    # 为了缓解非美国公益节点压力（考虑到很多人无视前面随机的美国节点），干脆也将其加入随机
    [
        "https://ghproxy.net/https://github.com",
        "英国",
        "[英国伦敦] - 该公益加速源由 [ghproxy.net] 提供提示：希望大家尽量多使用美国节点（每次随机 负载均衡），避免流量都集中到亚洲公益节点，减少成本压力，公益才能更持久~",
    ],
    [
        "https://ghfast.top/https://github.com",
        "其他",
        "[日本、韩国、新加坡、美国、德国等]（CDN 不固定） - 该公益加速源由 [ghproxy.link] 提供提示：希望大家尽量多使用美国节点（每次随机 负载均衡），避免流量都集中到亚洲公益节点，减少成本压力，公益才能更持久~",
    ],
    ...
    [
        "https://kkgithub.com",
        "其他",
        "[中国香港、日本、韩国、新加坡等] - 该公益加速源由 [help.kkgithub.com] 提供提示：希望大家尽量多使用美国节点（每次随机 负载均衡），避免流量都集中到亚洲公益节点，减少成本压力，公益才能更持久~",
    ],
] + _GITHUB_AKAMS_CN
GIT = {
    "github.com": [
...
CONDA = [
    {
        "https://anaconda.com/bioconda": [
            "https://mirrors.ustc.edu.cn/anaconda/cloud/bioconda"
        ],
        "https://anaconda.com/conda-forge": [
            "https://mirrors.ustc.edu.cn/anaconda/cloud/conda-forge"
        ],
        "https://anaconda.com/nvidia": [
            "https://mirrors.sustech.edu.cn/anaconda-extra/cloud/nvidia/"
        ],
        "https://anaconda.com/pytorch": [
...
def run(
    cmd: Sequence[str] | str, timeout: float | None = None, Print=True, **kwargs
...
def git(*args: str, retry=True, **kwargs) -> str | int | None:
    """2.49.0"""
    ...
    if idxs_github:
        ...
        if os.path.exists(to_local):
            ...
            Log.warning(
                f'Skip push set. Maybe you need run `{" ".join(cmds)}` if `git push` failed.'
            )
        return mirror_url
    else:
...
def reset_git(loc: Literal["system", "global", "local", "worktree", "file"] = "global"):
...
def _get_global_funcs(prefix="global_"):
    return {
        name.replace(prefix, ""): func
...
_FUNCS = {
    ...
    and name not in _GLOBAL_FUNCS.keys()
    and name not in _RESET_FUNCS.keys()
}
...
def argParser():
    ...
    parser = argparse.ArgumentParser(
        description=f'国内镜像源助手 Mirror CN 🧙🪄 🪞 🌐, 支持 {" ".join(_GLOBAL_FUNCS.keys())}',
        usage=__doc__,
    )
    parser.add_argument(
        "-y",
        "--smart",
        action="store_true",
        help=f"⭐ 无人值守智能判断，仅当访问谷歌超过4秒时设置镜像",
    )
    parser.add_argument(
        "-s",
        "--set",
        action="store_true",
        help="仅设置选定的全局镜像源 Set global mirrors for selected programs",
    )
    parser.add_argument(
        "-r",
        "--reset",
        "--remove",
        action="store_true",
        help="移除全局镜像源，走官方源 Remove(reset) mirrors in global config",
    )
    parser.add_argument(
...
def main():
    ...
    if len(args) == 1:
        ...
        if os.path.exists(url):
            ...
            if "releases" in args[0]:
                ...
                if "latest" in url:
                    ...
                    url = url.replace("/latest", "").replace(
                        "download", f"download/{tag}"
                    )
        ...
        if func and callable(func):
            ...
            Log.error(
                f"{args[0]}: 暂未支持或拼写错误。Unimplemented or check your spelling?"
            )


def set_mirror(*programes: str):
    return _run_funcs(_get_funcs(programes, _GLOBAL_FUNCS))


def reset_mirror(*programes: str):
    return _run_funcs(_get_funcs(programes, _RESET_FUNCS))
